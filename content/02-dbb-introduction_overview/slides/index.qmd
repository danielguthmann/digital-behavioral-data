...
## Ein Framework zur Fehlervermeidung
...
## Was wird vom Bias beeinflusst?

### Validität als Grundlage für "Aussagekraft"

![](images/bias_framework_upper_box.png){fig-align="center"}
...
-   Proxies for user traits or demographic criteria vary in reliabity
...
-   Behavioral biases affect the ecological/external validity of research, as they may condition the results of a study on the chosen platform or context. They are not entirely dependent on population biases, and when (explicit or implicit) assumptions are made about the users' behavioral patterns, they

    can affect both type I and II research (section 2.1) that, e.g., looks into users' needs or interests, among others.
